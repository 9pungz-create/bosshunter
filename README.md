...
- ข้อความแจ้งเตือนจะแสดงคำแนะนำ `กดปุ่มบันทึกเวลาคูลดาวน์ หลังบอสตาย` และมีปุ่ม `บันทึกเวลา` ให้กรอกเวลาเค้าดาวน์แบบ `HHMM` หรือ `HH:MM`
...
- `/set_boss_cooldown boss_id:boss_lv90_ch1 countdown:0030` ตั้งค่าคูลดาวน์ 30 นาที คำนวณเวลาเกิดรอบถัดไป และแสดงผลแบบส่วนตัว
...
- `บันทึกเวลา`: กดหลังจากฆ่าบอสตัวนั้น แล้วกรอกเวลาเค้าดาวน์รูปแบบ `HHMM` หรือ `HH:MM`
...
- `ตั้งค่าคูลดาวน์`: กดเพื่อกรอกเวลา `HHMM` หรือ `HH:MM` และแสดงผลสำเร็จแบบส่วนตัวเฉพาะคนที่กดปุ่ม หลังตั้งค่าสำเร็จบอทจะปิดปุ่มบนข้อความเตือนเดิม แสดงข้อความ `ข้อความนี้กำลังจะถูกลบในอีก 1 นาที` และลบข้อความนั้นหลัง 1 นาที
